...
The field surface continues for at least 0.7 meters beyond the <<Field Lines, field lines>> on all sides. The field margin extends from the field lines to the surrounding walls:

* Division A: 0.3 meters along the touch lines, 0.6 meters behind the goal lines.
* Division B: 0.3 meters on all sides.

Any area beyond the walls is used as a designated walking area for the <<Referee, referee>> and the <<Assistant Referee, assistant referee>>.
