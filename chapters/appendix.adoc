...
| <<Attacker In Defense Area>> | <<Ball In And Out Of Play, ball in play>> | Goals scored within 2 seconds of offense ending do not count. Increase <<Foul>> Counter | icon:check[role="green"]
