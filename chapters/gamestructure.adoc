...
Teams are encouraged to choose their preferred <<Hull Color of Robots, robot hull color>> (dark or bright) before the match. If both teams choose the same color, the <<Referee, referee>> assigns the colors by chance. The selected hull color must be used throughout the game.
