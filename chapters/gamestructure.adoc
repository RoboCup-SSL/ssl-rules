...
The <<Hull Color of Robots, robot's hull color>> (dark or bright) should match the <<Choosing Team Colors, team's color>> at the beginning of the game. Therefore, the starting blue team uses dark hulls, while the starting yellow team uses light hulls for the entire game. If teams switch colors during the game, they must *not* change their hull colors.
