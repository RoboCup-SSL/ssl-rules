...
The <<Hull Color of Robots, robot hull color>> (dark or bright) should match the <<Choosing Team Colors, team's color>> at the game beginning. Therefore, the starting blue team uses the dark hulls, while the starting yellow team uses light hulls for the entire game. If teams switch team color during the game, they must *not* switch hull colors.
