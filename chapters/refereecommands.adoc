...
When the ball is in play, the kicker may not touch the ball again until it has been touched by another robot or crossed the field boundaries. Also, the restrictions regarding the robot positions are lifted.
